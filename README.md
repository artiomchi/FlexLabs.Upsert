...
[![Build status](https://img.shields.io/github/check-runs/artiomchi/FlexLabs.Upsert/main?logo=github&label=build)](https://github.com/artiomchi/FlexLabs.Upsert/actions/workflows/build.yml?query=branch%3Amain)
